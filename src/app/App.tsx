...
export default function App() {
  ...
  return (
    ...
    //   {/* Navigation */}
    //   <nav className="fixed top-10 left-0 right-0 z-50 bg-card/95 backdrop-blur-sm border-b border-border">
    //     <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
    //       <div className="flex items-center gap-2">
    //         <Paintbrush className="w-7 h-7 text-accent" />
    //         <span className="font-bold text-xl text-primary">Pandit Home Wall Paint</span>
    //       </div>
    ...
    //         <button onClick={() => scrollToSection('about')} className="text-foreground hover:text-accent transition-colors font-medium">About Us</button>
    ...
    //               <button onClick={() => scrollToSection('services')} className="w-full text-left px-4 py-2 hover:bg-secondary transition-colors text-sm">Exterior Painting</button>
    //               <button onClick={() => scrollToSection('services')} className="w-full text-left px-4 py-2 hover:bg-secondary transition-colors text-sm">Interior Painting</button>
    //               <button onClick={() => scrollToSection('services')} className="w-full text-left px-4 py-2 hover:bg-secondary transition-colors text-sm">Wall Painting</button>
    //               <button onClick={() => scrollToSection('services')} className="w-full text-left px-4 py-2 hover:bg-secondary transition-colors text-sm">Waterproof Painting</button>
    //               <button onClick={() => scrollToSection('services')} className="w-full text-left px-4 py-2 hover:bg-secondary transition-colors text-sm">House Painting</button>
    //               <button onClick={() => scrollToSection('services')} className="w-full text-left px-4 py-2 hover:bg-secondary transition-colors text-sm">Terrace Waterproofing</button>
    //             </div>
    //           )}
    //         </div>
    ...
    //           {galleryOpen && (
    //             <div className="absolute top-full left-0 mt-2 bg-card shadow-xl rounded-lg py-2 min-w-[220px] border border-border">
    //               <button onClick={() => scrollToSection('gallery')} className="w-full text-left px-4 py-2 hover:bg-secondary transition-colors text-sm">Painting Photo Gallery</button>
    //               <button onClick={() => scrollToSection('gallery')} className="w-full text-left px-4 py-2 hover:bg-secondary transition-colors text-sm">Painting Video Gallery</button>
    //             </div>
    //           )}
    //         </div>

    //         <button onClick={() => scrollToSection('contact')} className="bg-accent text-accent-foreground px-6 py-2 rounded-lg hover:opacity-90 transition-opacity font-medium">Contact Us</button>
    //       </div>
    //     </div>
    //   </nav>

    //   {/* Hero Section */}
    //   <section id="home" className="relative min-h-screen flex items-center overflow-hidden" style={{ marginTop: '88px' }}>
    ...
    //           All projects of Pandit Home Wall Paint have achieved milestones
    //         </p>
    //       </div>
