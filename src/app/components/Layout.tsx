      ...
      <div className="bg-primary text-white py-2 text-sm">
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <a href="https://api.whatsapp.com/send?phone=917745871308&text=We%20offer%20professional%20Interior%20%26%20Exterior%20Painting%20Services%20with%20quality%20workmanship%20and%20affordable%20rates." target="_blank" className="hover:text-accent transition-colors"><MessageCircle className="w-3 h-3 md:w-4 md:h-4" /></a>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="https://api.whatsapp.com/send?phone=917745871308&text=We%20offer%20professional%20Interior%20%26%20Exterior%20Painting%20Services%20with%20quality%20workmanship%20and%20affordable%20rates." target="_blank" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-accent transition-colors">
