...
//               <p style="margin: 5px 0 0; color: #ffffff; font-size: 12px; opacity: 0.7;">📞 +91  7745871308 | ✉️ contact@pandithomewallpainting.com</p>
//             </td>
//           </tr>
//         </table>
//       </td>
...
export default async function handler(req: any, res: any) {
  ...
  try {
    const { error } = await resend.emails.send({
      from: 'Contact Form <contact@pandithomewallpainting.com',
